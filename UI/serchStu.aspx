<%@ Page Language="C#" AutoEventWireup="true" CodeFile="serchStu.aspx.cs" Inherits="UI_serchStu" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div> <div class="function">
          ...
          <p>
                <input type="text" name="number" id="number" placeholder="请输入学号" runat="server"/> 
